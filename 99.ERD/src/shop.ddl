...
ALTER TABLE jumun ADD CONSTRAINT IDX_jumun_FK0 FOREIGN KEY (user_id) REFERENCES user1 (user_id);

ALTER TABLE jumun_detail1 ADD CONSTRAINT IDX_jumun_detail1_PK PRIMARY KEY (jumun_detail_no);
ALTER TABLE jumun_detail1 ADD CONSTRAINT IDX_jumun_detail1_FK0 FOREIGN KEY (jumun_no) REFERENCES jumun (jumun_no);
